...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    descriptionEs: 'Verificación de elegibilidad de empleo',
    component: 'I9Section1Step',
    estimatedMinutes: 15,
    required: true,
    federalCompliance: true,
    allowStandalone: true,
    validationRules: ['citizenship', 'workAuthorization'],
  ...
  },
  {
    ...
    description: 'Additional I-9 documentation if required',
    descriptionEs: 'Documentación I-9 adicional si es necesaria',
    component: 'I9SupplementsStep',
    estimatedMinutes: 10,
    required: false,
    federalCompliance: true,
    allowStandalone: false,
    dependencies: ['i9-section1'],
  },
  {
    id: 'document-upload',
    ...
    descriptionEs: 'Cargue los documentos de identificación requeridos',
  ...
  },
  {
    ...
    descriptionEs: 'Información de contactos de emergencia',
    component: 'EmergencyContactsStep',
    estimatedMinutes: 5,
    required: true,
    federalCompliance: false,
    allowStandalone: true,
    validationRules: ['emergencyContact'],
  },
  {
    id: 'company-policies',
  ...
  },
  {
    ...
    descriptionEs: 'Autorización para verificación de antecedentes',
    component: 'BackgroundCheckStep',
    estimatedMinutes: 5,
    required: true,
    federalCompliance: false,
    allowStandalone: true,
    validationRules: ['consent'],
  },
  {
    id: 'photo-capture',
    title: 'Photo ID',
    titleEs: 'Foto de ID',
    description: 'Capture photo for employee ID badge',
    descriptionEs: 'Capturar foto para tarjeta de identificación',
